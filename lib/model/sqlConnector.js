...
var spQueries = {
	...
	SPSPEC:"select substring(parameter_name,2,len(parameter_name)) as name, data_type as dataType, parameter_mode as direction , character_maximum_length as maxlength from information_schema.parameters where specific_name = 'SP_NAME' "
} 
var DataType = {
	INT :sql.Int,
	BIT:sql.Bit,
